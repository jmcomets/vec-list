...
struct bench_fill_back {
    static void run(){
        ...
        bench<vec_list<T>,   microseconds, Empty, FillBack>("vec_list",   sizes);
        ...
        bench<vec_list<T>,   microseconds, Empty, FillBackInserter>("vec_list_inserter",   sizes);
...
//         bench<vec_list<T>,   microseconds, Empty, EmplaceBack>("vec_list",   sizes);
...
struct bench_fill_front {
    static void run(){
        ...
        bench<vec_list<T>,   microseconds, Empty, FillFront>("vec_list",   sizes);
...
//         bench<vec_list<T>,   microseconds, Empty, EmplaceFront>("vec_list",   sizes);
...
struct bench_linear_search {
    static void run(){
        ...
        bench<vec_list<T>,   microseconds, FilledRandom, Find>("vec_list",   sizes);
...
struct bench_random_insert {
    static void run(){
        ...
        bench<vec_list<T>,   milliseconds, FilledRandom, Insert>("vec_list",   sizes);
...
struct bench_random_remove {
    static void run(){
        ...
        bench<vec_list<T>,   milliseconds, FilledRandom, Erase>("vec_list",   sizes);
...
struct bench_sort {
    static void run(){
        ...
        bench<vec_list<T>,   milliseconds, FilledRandom, Sort>("vec_list",   sizes);
...
struct bench_destruction {
    static void run(){
        ...
        bench<vec_list<T>,   microseconds, SmartFilled, SmartDelete>("vec_list",   sizes);
...
struct bench_number_crunching {
    static void run(){
        ...
        bench<vec_list<T>,   milliseconds, Empty, RandomSortedInsert>("vec_list",   sizes);
